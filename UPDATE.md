...
- 修复data-select组件，select框错位问题
- 修复virtual-select组件 选择项不展示问题

# 0.16.0

- 新增drag-list组件，基础组件，支持实现顺序列表拖拽
...
- 新增menu组件 css设定样式
- 新增menu-item组件 menu-item-group组件 value属性
- 新增bubble组件 css设定样式

# 0.15.21

- 调整dropdown click为不可冒泡

# 0.15.17 - 0.15.20

- 新增collapse组件 css设定样式
...
- 新增vi-scroll-bar class设定样式

# 0.15.5

- 修复cascader 选项逻辑盲区
- 优化cascader-select 别名显示

# 0.15.3 - 0.15.4

- 新增cascader css变量（min-width系列）
...
- 新增dropdown 双向绑定 （有部分冲突）

# 0.15.0

- 新增级联菜单cascader
- 新增级联选择器cascader-select

# 0.14.17 - 0.14.18

- 新增dropdown自控开关功能(slot open)
...
- 修改input-table 内部组件td j类型警告错误问题
